              ...
              >
                <Dialog.Panel className=' w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all '>
                  ...
                  <div className='w-full flex items-center justify-center py-4 '>
                    <button
                      className={`flex-1 py-2 rounded text-sm outline-none ${accountType === "seeker"
                    ...
                    <button
                      className={`flex-1 mx-2 py-2 rounded text-sm outline-none ${accountType !== "seeker"
                        ? "bg-[#1d4fd862] text-blue-900 font-semibold"
                        : "bg-white border border-blue-400"
                        }`}
                  ...
                  >
                    ...
                    {errMsg && (
                      ...
                      <span
                        ...
                        onClick={() => window.location.replace("/requestPasswordReset")}
                      >
                        {isRegister ? "" : "Forget Password?"}
                      </span>
