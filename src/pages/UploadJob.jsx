...
const UploadJob = () => {
  ...
  const onSubmit = async (data) => {
    if (user?.accountType === "seeker") {
      setErrMsg("You must have a company account to upload job!");
      return
    }
    setIsLoading(true);
    setErrMsg(null);
      ...
      <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
        <div>
          ...
          <TextInput
              name='question1'
              label='Question 1'
              placeholder='eg. Why are you interested in this position/company?'
              type='text'
              required={true}
              register={register("question1", {
                required: "Question is required",
              })}
              error={errors.question1 ? errors.question1?.message : ""}
            />

          <TextInput
              name='question2'
              label='Question 2'
              placeholder='eg. What specific skills do you possess that make you a good fit for this position?'
              type='text'
              required={true}
              register={register("question2", {
                required: "Question is required",
              })}
              error={errors.question2 ? errors.question2?.message : ""}
            />

          <TextInput
              name='question3'
              label='Question 3'
              placeholder='eg. How do you prioritize tasks and manage your time effectively?'
              type='text'
              required={true}
              register={register("question3", {
                required: "Question is required",
              })}
              error={errors.question3 ? errors.question3?.message : ""}
            />

          <TextInput
              name='question4'
              label='Question 4'
              placeholder="eg. Can you provide an example of a successful project you've worked on in the past?"
              type='text'
              required={true}
              register={register("question4", {
                required: "Question is required",
              })}
              error={errors.question4 ? errors.question4?.message : ""}
            />
